...
FLO_ObjectivePressureReportRatio = 0.65;
FLO_ObjectivePressureVulnerableDuration = 2700;
FLO_ObjectivePressurePresencePerTick = 0.25;
FLO_ObjectivePressureSupportCapture = 4;
FLO_ObjectivePressureAnchorCapture = 12;
