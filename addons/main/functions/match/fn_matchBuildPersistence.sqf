...

{
    _dayResults pushBack [
        ...
        ["westObjectiveValue", _x get "westObjectiveValue"],
        ["eastObjectiveValue", _x get "eastObjectiveValue"],
        ["westObjectiveValueScore", _x get "westObjectiveValueScore"],
        ["eastObjectiveValueScore", _x get "eastObjectiveValueScore"],
